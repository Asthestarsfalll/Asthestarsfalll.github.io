...
$$
f(x_{0}+\Delta x,y_{0}+\Delta y)-f(x_{0}+\Delta x,y_{0}) = f'_{y}(x_{0}+\Delta x,y_{0}+\theta y)\Delta y
$$
...
梯度为 $\mathbf{grad}f(x_{0},y_{0})=\left( \frac{\partial f(x_{0},y_{0})}{\partial x}, \frac{\partial f(x_{0},y_{0})}{\partial y}\right)$，实际上就是沿着两个坐标轴方向的方向导数所组成的向量.
